...
export const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('[PRODUCT MODAL] 1. Submit iniciado');
    console.log('[PRODUCT MODAL] 2. FormData actual:', formData);
    console.log('[PRODUCT MODAL] 3. Es modo edición?:', isEditing);

    if (!validateForm()) {
      console.log('[PRODUCT MODAL] 4. Validación FALLÓ');
      return;
    }

    console.log('[PRODUCT MODAL] 5. Validación OK');
    ...
    try {
      ...
      console.log('[PRODUCT MODAL] 6. Datos preparados para enviar:', submitData);
      console.log('[PRODUCT MODAL] 7. Llamando a onSave...');

      await onSave(submitData);

      console.log('[PRODUCT MODAL] 8. onSave completado exitosamente');
      onClose();
    } catch (error) {
      console.error('[PRODUCT MODAL] 9. ERROR en handleSubmit:', error);
      console.error('[PRODUCT MODAL] 9a. Error tipo:', typeof error);
      console.error('[PRODUCT MODAL] 9b. Error detalles:', error);
    } finally {
      setSaving(false);
      console.log('[PRODUCT MODAL] 10. Finalizando submit (finally)');
    }
  };
