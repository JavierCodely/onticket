...
// ========================================
// NIGHT SESSIONS SYSTEM TYPES
// ========================================

export type NightSessionStatus = 'open' | 'closed';
...
export interface NightSessionProduct {
  id: string;
  session_id: string;
  product_id: string;
  club_id: string;
...
export interface NightSessionProductDetail extends NightSessionProduct {
  product_name: string;
  product_category: string;
  product_unit: string;
  product_sku?: string;
...
export interface NightSessionWithProducts extends NightSession {
  products: NightSessionProductDetail[];
...
export interface NightSessionFilters {
  session_date?: string;  // Fecha específica de la sesión (ej: "2025-10-15")
  status?: NightSessionStatus | 'all';
  category?: ProductCategory | 'all';
}

// Categorías de productos (incluyendo nuevas categorías de bebidas)
